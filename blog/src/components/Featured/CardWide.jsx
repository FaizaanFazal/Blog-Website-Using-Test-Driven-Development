  ...
  return (
    <div className="card-grid grid">
      <div className="card-grid-img">
        <img data-testid='FeaturedImg' src = {`${blogItemData.image}`} alt = "Featured image" className="object-fit-cover" />
      </div>
        ...
        <div>
          ...
          <h2 data-testid='headingfeatured' className="title-lg title featured-title">
            ...
            (<p className="text-lg text" data-testid='featureSummary'>
                    {`${blogItemData.content.substring(0, MAX_LENGTH)}...`}<a href="#">Read more</a>
            </p>) 
            :
